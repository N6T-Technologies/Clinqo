...
const DragAndDrop: React.FC<DragAndDropProps> = ({ field, isPending }) => {
    ...
    const handleSubmitLogo = async () => {
        ...
        // step-1: put request on this putURL to db passing current fileName as credential to save file to bucket
        // step-2: store getURL to db in respective user credentials
    };
