...
import { registerEmployee } from "@/actions/register-employee";
import { EmployeeRegError, EmployeeRegSchema, EmployeeRegSchemaType, StepInfo } from "@/types";
...
export default function EmployeeRegForm() {
    ...
    const [error, setError] = useState<EmployeeRegError | undefined>(undefined);

    const [isPending, startTransition] = useTransition();

    const form = useForm<EmployeeRegSchemaType>({
        resolver: zodResolver(EmployeeRegSchema),
    });

    const processForm: SubmitHandler<EmployeeRegSchemaType> = (data) => {
    ...
    type FieldName = keyof EmployeeRegSchemaType;
                    ...
                    >
                        {currentStep === 0 && (
                            <div>
                                ...
                                <p className="mt-1 text-sm leading-6 text-gray-600">Provide details of Employee</p>
